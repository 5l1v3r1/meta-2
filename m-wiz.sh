#SCRIPT BY W A S I DONT TRY TO COPY OR MODIFY 
#META TOOL FOR ALL METASPLOIT THINGS
...
echo -e "$red
                         ...
                         ╚═╝     ╚═╝       ╚══╝╚══╝ ╚═╝╚══════╝ 
                                                                v 1.1$rset"
echo " "                                                          
echo -e "$red                                   ▶ Coded by$grn WASIred ◀$rset"
echo -e "$red                              ⫸$ylo youtube.com/Hackerwasi$red ⫷$rset"
echo " "
echo " "
